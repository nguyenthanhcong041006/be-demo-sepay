...
â”œâ”€â”€ .env.example          # Template environment file (safe for version control)
â”œâ”€â”€ package.json          # Project manifest, dependencies, and npm scripts
â”œâ”€â”€ README.md             # Backend architecture and API documentation
â””â”€â”€ src/                  # Application source code
    â”œâ”€â”€ server.js         # Express entrypoint, middlewares, and HTTP listener
    â”œâ”€â”€ config/           # Configuration modules
    â”‚   â””â”€â”€ sepay.js      # SePay config loader and VietQR URL generator helper
    â”œâ”€â”€ controllers/      # HTTP request/response handlers
    â”‚   â””â”€â”€ orderController.js # Handles order creation, polling, cancellations, and webhooks
    â”œâ”€â”€ routes/           # Endpoint router definitions
    â”‚   â”œâ”€â”€ orderRoutes.js     # Routes for /api/orders
    â”‚   â””â”€â”€ webhookRoutes.js   # Route for /api/sepay/webhook
    â””â”€â”€ services/         # Core business logic layer
        â””â”€â”€ orderService.js    # In-memory storage, order generator, webhook matching logic
```
...
- **Request Body**:
  ```json
  {
    ...
    "amount": 200000,
    "serviceName": "GÃ³i ChuyÃªn Nghiá»‡p (Pro)",
    "note": "Payment note"
  }
  ```
